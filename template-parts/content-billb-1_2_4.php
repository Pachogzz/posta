<?php 
/**
 * Template part for displaying 7 notes - two sizes - and 1 bill board banner
 *
...
?>
<section class="bloque_notas--billb_1_2_4 py-6" style="background-image: url( <?php echo $imagenFondo; ?> ); background-color: <?php echo $colorFondo; ?> !important;">
    <div class="container">
        <!-- Desktop block -->
        <div class="d-none d-sm-none d-md-none d-lg-block">
            <div class="row">
                ...
                <div class="row mx-3 align-self-stretch">
                    <div class="col-12 col-md-6 col-lg-9 nota modulo-publicidad">
                        <img src="http://fakeimg.pl/970x300/333/ccc/?text=BillBoard" class="img-fluid d-block mb-0" alt="Publicidad...">
