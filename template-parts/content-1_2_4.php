<?php 
/**
 * Template part for displaying 7 notes - two sizes - no banners
 *
...
?>
<section class="bloque_notas--1_2_4 py-6" style="background-image: url( <?php echo $imagenFondo; ?> ); background-color: <?php echo $colorFondo; ?> !important;">
    <div class="container">
        <!-- Desktop block -->
