<?php 
/**
 * Template part for displaying 8 notes two sizes 1 half page banner
 *
...
?>
<section class="bloque_notas--2_bb_3_4_l py-6" style="background-image: url( <?php echo $imagenFondo; ?> ); background-color: <?php echo $colorFondo; ?> !important;">
    <div class="container">
        <!-- Desktop block -->
                    ...
                    <div class="col-12 col-md-6 nota modulo-publicidad">
                        <script>
                          ...
                          googletag.cmd.push(function() {
                            googletag.defineSlot('/90573685/boxbanner_home_bloque_3', [[300, 600], [300, 250]], 'div-gpt-ad-1610517173407-0').addService(googletag.pubads());
                            googletag.pubads().enableSingleRequest();
                            googletag.enableServices();
                          });
                        </script>

                        <!-- /90573685/boxbanner_home_bloque_3 -->
                        <div id='div-gpt-ad-1610517173407-0'>
                          <script>
                            googletag.cmd.push(function() { googletag.display('div-gpt-ad-1610517173407-0'); });
                          </script>
                        </div>
