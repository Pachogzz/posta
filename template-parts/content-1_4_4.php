<?php 
/**
 * Template part for displaying 9 notes - two sizes - no banners
 *
...
?>
<section class="bloque_notas--1_4_4 py-6" style="background-image: url( <?php echo $imagenFondo; ?> ); background-color: <?php echo $colorFondo; ?> !important;">
    <div class="container">
        <!-- Desktop block -->
