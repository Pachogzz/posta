...
?>
<section class="bloque_notas--11_bb" style="background-image: url( <?php echo $imagenFondo; ?> ); background-color: <?php echo $colorFondo; ?> !important;">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 nota modulo-publicidad">
                        <script>
                          ...
                          googletag.cmd.push(function() {
                            googletag.defineSlot('/90573685/Boxbanner_home_bloque1', [[300, 250], [300, 600]], 'div-gpt-ad-1610518020108-0').addService(googletag.pubads());
                            googletag.pubads().enableSingleRequest();
                            googletag.enableServices();
                          });
                        </script>

                        <!-- /90573685/Boxbanner_home_bloque1 -->
                        <div id='div-gpt-ad-1610518020108-0'>
                          <script>
                            googletag.cmd.push(function() { googletag.display('div-gpt-ad-1610518020108-0'); });
                          </script>
                        </div>
